...
public class EnchantTransferMod implements ModInitializer {
	...
	public void onInitialize() {
		Registry.register(Registry.ITEM, new Identifier("enchanttransfer", "magic_card_item"), MAGIC_CARD_ITEM);
		Registry.register(Registry.BLOCK, new Identifier("enchanttransfer", "transfer_table_block"), TRANSFER_TABLE_BLOCK);
		Registry.register(Registry.ITEM, new Identifier("enchanttransfer", "transfer_table_block"), TRANSFER_TABLE_ITEM);
	}
}
